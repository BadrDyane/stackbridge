...
async def poll_gmail_workflow(workflow_id: str) -> None:
    """
    APScheduler job: poll Gmail for new messages for a single workflow.
    Creates a Run row for each new qualifying message.
    """
    ...
    async with AsyncSessionLocal() as db:
        ...
        # Update history ID and last polled timestamp
